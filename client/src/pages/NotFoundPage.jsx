  ...
  return (
    <div style={{ minHeight: '100vh', background: colors.gray50, fontFamily: colors.fontFamily, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      <Card style={{ maxWidth: '480px', textAlign: 'center' }}>
        ...
        <Alert variant="info">
          Available pages: <code>/book-setup</code>, <code>/quote-calculator</code>, <code>/royalty-dashboard</code>, <code>/lulu-integration</code>, <code>/orders</code>, <code>/analytics</code>, <code>/crm-pipelines</code>, <code>/settings</code>
        </Alert>
      </Card>
    </div>
  );
