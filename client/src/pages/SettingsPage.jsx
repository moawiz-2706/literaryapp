    ...
    <div>
      ...
      <Card>
        ...
        <div style={{ fontSize: 13, lineHeight: 2, color: colors.gray600 }}>
          ...
          <div>Platform: Literary App Integration</div>
      ...
      <Card style={{ marginTop: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          ...
          <Button variant="secondary" size="sm" onClick={() => navigate(`/crm-pipelines?locationId=${locationId}`)}>
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, marginBottom: 16 }}>
        ...
        <Card>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <h3 style={{ margin: 0, fontSize: 16, fontWeight: 600 }}>App Connection</h3>
            <Badge variant={ghlStatus} dot>{ghlStatus === 'success' ? 'Valid' : ghlStatus === 'warning' ? 'Expired' : 'Missing'}</Badge>
          </div>
          <p style={{ fontSize: 13, color: colors.gray500, margin: 0 }}>
            {checks.ghl?.message || 'App connection status unknown.'}
          </p>
        </Card>
